"""
Customized data utils
The codes were refactored from [tensornets](https://github.com/taehoonlee/tensornets/blob/master/tensornets/datasets/voc.py) 
"""
...
def get_annotations(data_dir, files):
    ...
    for filename in files:
        ...
        annotations[filename] = [[] for _ in range(classes_num)]
...
def load_train(data_dir, data_name,
               ...
               target_size=416, anchors=5, classes=classes_num,
